# Nano Banana Gemini 2.5 UXP Plugin for Photoshop

This plugin adds a new panel to photoshop which allows selecting areas of the image and editing them using Google Gemini 2.5 Nano-Banana Generative imaging AI model.
